...
public class Schedule extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        String url = "http://10.0.2.2:3000/lectures.php?id="+userId;
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                int from =Integer.parseInt(obj.getString("start_time").split(":")[0])-7;
                                ...
                                lecutres.add(new lecutre(from,colome,name));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Schedule.this, error.toString(), Toast.LENGTH_SHORT).show();
        ...
        {
            Intent intent = new Intent(Schedule.this, Main_Dashboard.class);
