...
public class Addstudent extends AppCompatActivity {
    ...
    private void setUpViews() {
        ...
        btnAddUser.setOnClickListener(v -> {
            ...
            String userClass = sharedPreferences.getString("class", "default_value");
            ...
            addUserToDatabase(fullName, userName, email, role, userClass, password);
        });
    }
    ...
    private void addUserToDatabase(String fullName, String userName, String email, String role, String userClass, String password) {
        String url = "http://10.0.2.2:3000/addstudent.php";
